...
pathSC = '/home/neuro_img/Users/Roberta/LOWFIELD_TVB/HC01/Connectome/SC_AVG.zip'
...
ngen = 10
type_acq = "AVG_muok"
pareto_name = "pareto_front_tavg_noiseAmato_provaaaaaa"+str(pop_size)+"_"+str(ngen)+type_acq+".npz"
